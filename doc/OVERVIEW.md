...
For proper documentation, see [API reference](https://rawcdn.githack.com/rogierschouten/timezonecomplete/master/doc/typedoc/index.html)
...
Error documentation can be found in the [API reference](https://rawcdn.githack.com/rogierschouten/timezonecomplete/master/doc/typedoc/index.html). All `throws` clauses in the API reference have the corresponding value of the `Error#name` property as first item.
